  ...
  <div className="min-h-screen bg-background px-4 py-12">
    <div className="container max-w-lg mx-auto">
      ...
      <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
        <p>Repeatt is currently under development. The product is not yet available for public use.</p>
        <p>By joining the waitlist, you are expressing interest in being notified when Repeatt launches. <strong className="text-foreground">Joining the waitlist does not create a financial service relationship</strong> of any kind.</p>
